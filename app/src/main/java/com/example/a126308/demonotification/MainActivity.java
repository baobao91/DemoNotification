package com.example.a126308.demonotification;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnNotify2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                bigText.bigText("This is one big text lndlknsdmc;ldmvlkdnfz vlknz vldznmvl;kzc vlkznxc vlzkxcnv lzkxncv ldzxkcnv lxckn cxl k");
